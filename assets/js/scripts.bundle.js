...
(function ($) {
  ...
  if (typeof util === 'undefined')
    throw new Error('Util class is required and must be included before ' + pluginName);
  ...
  $.fn[pluginName] = function (options) {
    ...
    var Plugin = {
      ...
      adjustLockContainer: function () {
        ...
        if (typeof lockLeft === 'undefined')
          lockLeft = 0;
        if (typeof lockRight === 'undefined')
          lockRight = 0;
          ...
          $(tr).find('.' + pfx + 'datatable-cell').each(function (tdi, td) {
            ...
            if (typeof column !== 'undefined') {
              ...
              if (typeof column.selector !== 'undefined' && column.selector !== false) {
                ...
                if ($(td).find('.' + pfx + 'checkbox [type="checkbox"]').length > 0)
                  return;
              ...
              if (typeof column.subtable !== 'undefined' && column.subtable) {
                ...
                if ($(td).find('.' + pfx + 'datatable-toggle-subtable').length > 0)
                  return;
      ...
      paging: function (meta, callback) {
        var pg = {
          ...
          init: function (meta) {
            ...
            if ($(pg.pager).hasClass(pfx + 'datatable-paging-loaded'))
              return;
          ...
          gotoPage: function (e) {
            ...
            if ($(this).hasClass(pfx + 'datatable-pager-link-active'))
              return;
      ...
      setupSubDatatable: function () {
        ...
        if (typeof subTableCallback !== 'function')
          return;

        // subtable already exist
        if ($(datatable.table).find('.' + pfx + 'datatable-subtable').length > 0)
          return;
      ...
      stateKeep: function (key, value) {
        ...
        if (Plugin.getOption('data.saveState') === false)
          return;
        if (localStorage) {
      ...
      stateUpdate: function (key, value) {
        ...
        if (typeof ori === 'undefined' || ori === null)
          ori = {};
      ...
      sorting: function () {
        var sortObj = {
          ...
          setIcon: function () {
            ...
            if (typeof column !== 'undefined' && typeof column.sortable !== 'undefined' && column.sortable === false)
              return;
...
KTUtil.ready(function () {
  ...
  // Init Setting Selection Panel
  KTLayoutSettingPanel.init('kt_setting_panel');
...
var KTLayoutSettingPanel = function () {
  // Private properties
  var _element;
  var _offcanvasObject;
  ...
  var _init = function () {
    _offcanvasObject = new KTOffcanvas(_element, {
      ...
      baseClass: 'offcanvas',
      placement: 'right',
      closeBy: 'kt_setting_panel_close',
      toggleBy: 'kt_setting_panel_toggle'
    });
  }
  ...
  return {
    init: function (id) {
      _element = KTUtil.getById(id);
      _notificationsElement = KTUtil.getById('kt_setting_panel_notifications');
      _logsElement = KTUtil.getById('kt_setting_panel_logs');
      _settingsElement = KTUtil.getById('kt_setting_panel_settings');
...
// Webpack support
if (typeof module !== 'undefined') {
  module.exports = KTLayoutSettingPanel;
}
