      ...
      <div class="modal-body">
        <form id="ph_Form">
          <div class="tab-content">
            <div class="row pt-1">
              <label for="fldKey" class="col-form-label col-sm-2 text-lg-right text-left"><?php echo getLabel('Key'); ?></label>
              <div class="col-12 col-sm-4">
                <input id="fldId" type="hidden" value=""/>
                <input id="fldKey" class="form-control form-control-sm" type="text" value="" required="true" />
              </div>
            ...
            <div class="row pt-1">
              <label for="fldValue" class="col-form-label col-sm-2 text-lg-right text-left"><?php echo getLabel('Value'); ?></label>
              <div class="col-12 col-sm-4">
                <input id="fldValue" class="form-control form-control-sm" type="text" value="" required="true" />
              </div>
