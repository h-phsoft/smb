    ...
    <div class="card-body">
      <form id="PhForm" class="form-horizontal">
        ...
        <div class="form-group-sm row pt-1">
          ...
          <div class="col-sm-4">
            <select id="BoxId" class="form-control form-control-sm form-select">
        ...
        <div class="form-group-sm row pt-1">
          ...
          <label for="Rem" class="control-label col-sm-1 text-center"><?php echo getLabel('Remarks'); ?></label>
          <div class="col-sm-4">
            <input id="Rem" class="form-control form-control-sm" type="text" utocomplete="off" value="">
          </div>
        </div>
        <div class="form-group-sm row pt-1">
          <hr class="w-100">
