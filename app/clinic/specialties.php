        ...
        <form id="ph_Form">
          <div class="tab-content">
            <div class="row pt-1">
              ...
              <label for="fldStorId" class="col-form-label col-sm-1 text-lg-right text-left"><?php echo getLabel('Store'); ?></label>
              <div class="col-12 col-sm-5">
                <select id="fldStorId" class="form-control form-control-sm form-select">
                  <?php
                  foreach ($aStors as $element) {
                  ?>
