        ...
        <form id="ph_Form">
          <div class="tab-content">
            <div class="row pt-1">
              ...
              <label for="fldDoctorId" class="col-form-label col-sm-1 text-lg-right text-left"><?php echo getLabel('Doctor'); ?></label>
              <div class="col-12 col-sm-5">
                <select id="fldDoctorId" class="form-control form-control-sm form-select">
                  <?php
              ...
              <label for="fldMethodId" class="col-form-label col-sm-1 text-lg-right text-left"><?php echo getLabel('Method'); ?></label>
              <div class="col-12 col-sm-5">
                <select id="fldMethodId" class="form-control form-control-sm form-select">
                  <?php
            ...
            <div class="row pt-1">
              ...
              <div class="col-12 col-sm-2">
                <input id="fldAmt" class="form-control form-control-sm" type="number" step="0.1" min="1" value="" autocomplete="off" required="true" />
              </div>
